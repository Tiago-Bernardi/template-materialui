...
const CriarTarefa = ({handleClose, tarefas, setTarefas}) =>{
  ...
  return(
    <Grid container spacing={2}>
      <Card sx={style}>
        <CardHeader
          title="Está arrumando problema com novas tarefas né?"
          subheader="Cadastre aqui as suas novas tarefas"
        /> 
        <CardContent sx={{
          width: '95%',
          maxWidth: '100%',
          ...
          <Grid container spacing={2} mt={1}>
            ...
            <Grid item xs={3}>  
              <FormControl fullWidth>
                ...
                >
                  <MenuItem value={'Nem comecei :-('}>Nem comecei :-(</MenuItem>
                  <MenuItem value={'Está indo :-)'}>Está indo :-)</MenuItem>
                  <MenuItem value={'Concluída XD'}>Concluída XD</MenuItem>
                </Select>
              </FormControl>
            </Grid>
